...
{
	{
		[
			format
			[
				"Un véhicule de type <t color='#DF7401'>%1</t> est parti sans payer sa facture d'essence s'élevant à <t color='#8cff9b'>%2</t>BTC.La plaque du véhicule est %3 et sa position est %4.",
	...
	[format["Vous êtes parti sans payer votre facture d'essence s'élevant à <t color='#8cff9b'>%1</t>BTC.<br/>Votre véhicule a été <t color='#DF0101'>signalé</t>.", [_bill] call AlysiaClient_fnc_numberText]] call AlysiaClient_fnc_info;
