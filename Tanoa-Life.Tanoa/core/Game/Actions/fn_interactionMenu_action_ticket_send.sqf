...
if (_price < 100) exitWith {
	["La somme à payer doit être <t color='#04B404'>supérieure ou égale à 100BTC</t>."] call AlysiaClient_fnc_error;
};
if (_price > 999999) exitWith {
	["La somme à payer ne doit pas <t color='#04B404'>dépasser</t> <t color='8cff9b'>999.999</t>BTC."] call AlysiaClient_fnc_error;
};
...
if (([_desc] call CBA_fnc_strLen) > 150) exitWith {
