...
class MAV_ctrlButtonOK: MAV_ctrlButton
{
	default = 1;
	idc = IDC_OK;
	text =  DouillesSTR_DISP_OK;// DouillesSTR_3DEN_Button_OK;
};
class MAV_ctrlButtonCancel: MAV_ctrlButton
{
	idc = IDC_CANCEL;
	text =  DouillesSTR_DISP_CANCEL;// DouillesSTR_3DEN_Button_Cancel;
};
class MAV_ctrlButtonClose: MAV_ctrlButtonCancel
{
	text =  DouillesSTR_DISP_CLOSE;// DouillesSTR_3DEN_Button_Close;
};
