...
class Maverick_ConvoySidemission
{
	class Config
	{
		...
		SleepTime								= 5;
		MakePlayersHostileFor					= 600;
		TimeoutBetweenMarkers					= 1;
		SidesNotAttackable[]					= {};
		AIDifficulty[] = {
												{"aimingAccuracy", 1},
												{"aimingShake", 1},
	...
	class ConvoyConfigurationsPool
	{
		...
		class GoldBarTransport
		{
			...
			class Vehicles
			{
				...
				vehiclesInOrder[]				= {"Lemon_Ural_Farm"};
				vehiclesSpawnMarkersInOrder[]	= {"mav_convoy_spawn1"};
		...
		class WeaponTransport
		{
			...
			class Vehicles
			{
				// Vehicle configuration
				vehiclesInOrder[]				= {"Lemon_Ural_Farm"};
				vehiclesSpawnMarkersInOrder[]	= {"mav_convoy_spawn2"};
				vehiclesInheritDirection		= 1;
