...
{
	_index = _list lbAdd format["%1 - Prix : %2BTC - Licence : %3", getText(_x >> "name"), [getNumber(_x >> "price")] call AlysiaClient_fnc_numberText, [getText(_x >> "license")] call AlysiaClient_fnc_licenseGetName];
