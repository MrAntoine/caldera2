...
private _text = "<t color='#535353' size='1' shadow='0' align='center' font='PuristaMedium'>AFIN DE MIEUX T'ACCOMPAGNER <t font='PuristaBold'>DANS TON AVENTURE,<t font='PuristaMedium'>, NOUS AVONS MIS EN PLACE UN WIKI AVEC DIVERSES CONSEILS ET ASTUCES <t font='PuristaBold'>'40 %'<t font='PuristaMedium'>. IL EST CONSULTABLE A L'ADRESSE <t font='PuristaBold'>'SUIVANTE'<t font='PuristaMedium'> wiki.caldera-life.fr</t>";

//((uiNamespace getVariable "mainmenu01")displayCtrl 0007) ctrlShow true;

	//ctrlSetText [0007, _text];
