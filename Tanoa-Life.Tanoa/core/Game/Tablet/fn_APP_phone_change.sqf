...
if (g_atm < _price) exitWith {
	[format["Vous n'avez pas assez d'argent<br/>Prix : <t color='#8cff9b'>%1</t>BTC", [_price] call AlysiaClient_fnc_numberText]] call AlysiaClient_fnc_error;
};

_action =
[
	"Êtes-vous sûr de vouloir changer de numéro ? Une fois validé vos anciens contacts ne pourront plus vous joindre.<br/><br/><t align='left'>Prix</t><t align='right'><t color='#8cff9b'>10.000</t>BTC</t>",
